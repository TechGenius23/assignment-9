...
const Ourproject = () => {
    return (
        <div>
            <div>
                <p>Our Project</p>
                <p>A complete real estate project that boosts value focuses on key elements like modern infrastructure, eco-friendly designs, and smart home technology. By incorporating energy-efficient systems, sustainable materials, and advanced amenities like parks, gyms, and smart tech, the development becomes more attractive to buyers. This drives demand, raises property values, and enhances the overall appeal of the neighborhood.</p>
            </div>
            <div>
